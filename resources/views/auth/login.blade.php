    ...
    <div class="flex">
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md">
                ...
                <header class="font-semibold bg-white text-gray-900 py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md text-center text-xl">
                    {{ __('Connexion') }}
                </header>
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        @error('email')
                        <p class="text-red-500 text-sm font-semibold mt-4">
